  ...
  const paymentHandler = async () => {
    ...
    if (method === "online") {
      const stripePromise = loadStripe(
        "pk_test_51RrW11HbFz2tXQMMF0S1ChR0QX3UWiw42IHYIukPOwrRDlccwgne35HQOUwo2IriO7s0VEaDkXVCCWgiSSgUoTcL00zpYrtZGb"
      );
                ...
                <div className="flex-1 md:ml-4 text-center md:text-left">
                     <h2 className="text-lg font-medium">
                        ...
                        <p className="text-sm text-muted-foreground dark:text-gray-400">
                          ₹ {e.product.price} X {e.quauntity}
                        </p>
                        <p className="text-sm text-muted-foreground dark:text-gray-400">
                          ₹ {e.product.price * e.quauntity}
                        </p>
                </div>
                </div>
               ))}
